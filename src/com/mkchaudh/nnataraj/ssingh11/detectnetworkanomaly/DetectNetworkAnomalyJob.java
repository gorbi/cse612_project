...
public class DetectNetworkAnomalyJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileUtil.fullyDelete(new File(new Path(args[1] + "_user_profile").toString()));
        FileUtil.fullyDelete(new File(new Path(args[1]).toString()));

        Job job = new Job();

        /* Autogenerated initialization. */
        initJob(job, LocationMapper.class, LocationReducer.class);
        ...
        if (job.waitForCompletion(true)) {
            ...
            /* Autogenerated initialization. */
            initJob(job, UserProfileMapper.class, UserProfileReducer.class);
            ...
            /* This is an example of how to set input and output. */
            FileInputFormat.setInputPaths(job, args[1] + "_location");
            FileOutputFormat.setOutputPath(job, new Path(args[1]+"_user_profile"));
